...
if ( CLIENT ) then
	language.Add( "Tool.stacker.name", "Стакер" )
	language.Add( "Tool.stacker.desc", "Стакер" )
...
function TOOL.BuildCPanel( CPanel )
	...
	params.Options["Вправо"] = {stacker_dir = "3"}
	params.Options["Влево"] = {stacker_dir = "4"}
	params.Options["Назад"] = {stacker_dir = "5"}
	params.Options["Вперёд"] = {stacker_dir = "6"}
	CPanel:AddControl( "ComboBox", params )

	

	CPanel:AddControl( "Header", { Text = "Advanced Options", Description	= "Эти параметры предназначены для опытных пользователей. Оставьте их все по умолчанию (0), если вы не понимаете, что они делают." }  )
	CPanel:AddControl( "Button",  { Label	= "Сброс настроек",
					Command = "stacker_resetoffsets",
					Text = "Reset"}	 )
	CPanel:AddControl( "Slider",  { Label	= "Компенсировать X (вперед/назад)",
					Type	= "Float",
					Min		= -1000,
					Max		= 1000,
					Value	= 0,
					Command = "stacker_offsetx"}	 )
	CPanel:AddControl( "Slider",  { Label	= "Компенсировать Y (Влево/Вправо)",
					Type	= "Float",
					Min		= -1000,
					Max		= 1000,
					Value	= 0,
					Command = "stacker_offsety"}	 )
	CPanel:AddControl( "Slider",  { Label	= "Компенсировать Z (Вверх/Вниз)",
					Type	= "Float",
					Min		= -1000,
					Max		= 1000,
					Value	= 0,
					Command = "stacker_offsetz"}	 )
	CPanel:AddControl( "Slider",  { Label	= "Повернуть шаг",
					Type	= "Float",
					Min		= -360,
					Max		= 360,
					Value	= 0,
					Command = "stacker_rotp"}	 )
	CPanel:AddControl( "Slider",  { Label	= "Повернуть рыскание",
					Type	= "Float",
					Min		= -360,
					Max		= 360,
					Value	= 0,
					Command = "stacker_roty"}	 )
	CPanel:AddControl( "Slider",  { Label	= "Повернуть рулон",
					Type	= "Float",
					Min		= -360,
					Max		= 360,
					Value	= 0,
